module.exports = {
  message: {
    ...
    ZiLiaoBFHeBZ: 'Data Backup & Protection Services',
    ZhuoMianWH: 'Help Desk Support',
    DianNaoJSZC: 'Computer Tech Support',
    ITWeiHu: 'IT Maintenance Services',
    WangLuoGL: 'Network Management Services',
    ...
    // maintain
    maintainDiv1: 'China Sky will help you find the right IT solution for your business',
    ...
    maintainDiv2: 'The benefits of using \n china sky services',
    ...
    softwareText1_1: 'China Sky Technology is a one-stop computer programming outsourcing service provider: requirements analysis, customized solutions, architecture, UI/UX design, development, testing, deployment, maintenance, system management and support. ',
   ...
   // move
    ...
    mallCoreBigT: 'Benefits of using China Sky services',
    ...
    QiDong: 'Start',
    ZhiChi: 'Support',
    processText1_1: 'Keep in touch with customers so we can discuss services in detail, answer any questions you may have and ',
    processText1_a1:'',
    processText1_2:'',
    processText1_a2:'provide quotes',
    processText1_3:'. First, you need to sign back our quotation. A 50% prepayment is required after signing, and the remainder will be paid when the website goes live. We accept bank transfers. The hosting fee is calculated from the time the website goes live. ',
    processText2: 'After signing and paying, we will discuss with the customer about the design direction and ask for relevant information. At the same time, we will sort out the design direction from the market perspective and other peer websites. This stage is to grasp your needs, and at the same time Enhance our designs for best results. ',
    ...
    processText5: 'After the website is completed, it is ready to go online. If you have your own domain name, then we have different options to recommend the best domain configuration for your project. Whether it\'s a new or existing domain, we\'ll tell Google to re-index the site, beginning its journey toward your audience. ',
    processText6: 'After the website went live, our work continued. For many clients, this is the beginning of our service! We will continue to provide support based on your needs, and if you do not wish to make updates through the CMS, we can provide you with support for an hourly fee. We also provide SEO (Search Engine Optimization) services to improve your ranking in Google\'s agreed phrases. As your business grows or changes, we\'ll be there for you when you need it. ',
    // Js prompt
